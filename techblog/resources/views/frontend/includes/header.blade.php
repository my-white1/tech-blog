 ...
 <header class="tech-header header">
    <div class="container-fluid">
        <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
            ...
            <a class="navbar-brand" href="{{ asset('frontend/tech-blog/tech-index.html') }}"><img
                    src="{{ asset('frontend/tech-blog/images/version/tech-logo.png') }}" alt=""></a>
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ asset('frontend/tech-blog/tech-index.html') }}">Home</a>
                    </li>
                    <li
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="tech-single.html" title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_01.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                            ...
                                                            <div class="blog-meta">
                                                                <h4><a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="tech-single.html" title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_02.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Science</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_03.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Science</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_04.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Science</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_05.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_06.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Technology</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_07.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Technology</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_08.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Technology</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_09.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_10.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Social Media</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_11.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Social Media</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_12.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Social Media</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_13.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_14.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Car News</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_15.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Car News</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_16.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Car News</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_17.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_18.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Worldwide</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_19.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Worldwide</span>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="blog-box">
                                                            <div class="post-media">
                                                                <a href="{{ asset('frontend/tech-blog/tech-single.html') }}"
                                                                    title="">
                                                                    <img src="{{ asset('frontend/tech-blog/upload/tech_menu_20.jpg') }}"
                                                                        alt="" class="img-fluid">
                                                                    <div class="hovereffect">
                                                                    </div><!-- end hover -->
                                                                    <span class="menucat">Worldwide</span>
